            ...
            {modalType === 'transaction' ? (
              <div className="space-y-5 relative z-[105]">
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="Untuk apa nih?" value={formData.note} onChange={(e) => setFormData({...formData, note: e.target.value})} className="w-full p-6 bg-white rounded-2xl border-4 border-slate-900 outline-none font-bold shadow-[4px_4px_0px_0px_rgba(15,23,42,1)] text-slate-900" />
                </div>
                <button 
